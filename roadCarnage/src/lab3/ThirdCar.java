 ...
 * @author Levchuk
 */
public class ThirdCar extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		nameB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/z-type.png"));
		...
		useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/buy200small.gif"));
	...
	private void useBMouseEntered(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_useBMouseEntered
		bEnter();
		if (bought == false)
			useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/buy200big.gif"));
		else
	...
	private void useBMousePressed(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_useBMousePressed
		if (bought == false && balance >= 200) {
			...
			useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/equipBig.gif"));
			repaint();
		} else if (bought == false && balance < 200) {
			errorS();
		} else if (bought == true) {
			equipS();
			eAction();
	...
	private File backgroundSource = new File(System.getProperty("user.dir") + "/src/images/garage.jpg"),
			carSource = new File(System.getProperty("user.dir") + "/src/images/Z-Type-GTA2.png"),
	...
	public void paintComponent(Graphics g) {
		try {
			...
			Logger.getLogger(ThirdCar.class.getName()).log(Level.SEVERE, null, ex);
		}
