 ...
 * @author Levchuk
 */
public class FourthCar extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		nameB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/furore-gt.png"));
		...
		useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/buy400small.gif"));
	...
	private void useBMouseEntered(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_useBMouseEntered
		bEnter();
		if (bought == false)
			useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/buy400big.gif"));
		else
	...
	private void useBMousePressed(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_useBMousePressed
		if (bought == false && balance >= 400) {
			...
			useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/equipBig.gif"));
			repaint();
		} else if (bought == false && balance < 400) {
			errorS();
		} else if (bought == true) {
			equipS();
			eAction();
	...
	private File backgroundSource = new File(System.getProperty("user.dir") + "/src/images/garage.jpg"),
			carSource = new File(System.getProperty("user.dir") + "/src/images/FuroreGT-GTA2.png"),
	...
	public void paintComponent(Graphics g) {
		try {
			...
			Logger.getLogger(FourthCar.class.getName()).log(Level.SEVERE, null, ex);
		}
		...
		g.drawImage(barF, 689, 218, null);
		g.drawImage(barF, 753, 218, null);
		// Now strength
		g.drawImage(barF, 497, 318, null);
		g.drawImage(barF, 561, 318, null);
		g.drawImage(barF, 625, 318, null);
		...
		g.drawImage(barF, 625, 418, null);
		g.drawImage(barF, 689, 418, null);
