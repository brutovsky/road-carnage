 ...
 * @author Levchuk
 */
public class FifthCar extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		descriptionB = new javax.swing.JButton();
		...
		nameB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/tank.gif"));
		...
		useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/buy1000small.gif"));
		...
		// rarrowB.setIcon(new
		// javax.swing.ImageIcon(System.getProperty("user.dir")+"/src/images/rarrowsmall.png"));
		...
		descriptionB.setBorderPainted(false);
		descriptionB.setContentAreaFilled(false);
		descriptionB.setFocusPainted(false);
		descriptionB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/description.gif"));
		descriptionB.setFocusable(false);
		descriptionB.setIconTextGap(0);
		descriptionB.setMaximumSize(new java.awt.Dimension(426, 107));
		descriptionB.setMinimumSize(new java.awt.Dimension(426, 107));
		descriptionB.setPreferredSize(new java.awt.Dimension(426, 107));
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(layout.createSequentialGroup().addGap(163, 163, 163)
								...
								.addGap(32, 32, 32).addComponent(rarrowB, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(descriptionB,
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addGap(48, 48, 48).addComponent(nameB,
										...
										javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addGap(112, 112, 112)
						.addComponent(descriptionB, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	private void useBMouseEntered(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_useBMouseEntered
		bEnter();
		if (bought == false)
			useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/buy1000big.gif"));
		else
	...
	private void useBMousePressed(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_useBMousePressed
		if (bought == false && balance >= 1000) {
			...
			useB.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir") + "/src/images/equipBig.gif"));
			repaint();
		} else if (bought == false && balance < 1000) {
			errorS();
		} else if (bought == true) {
			eAction();
			equipS();
	...
	private void rarrowBMouseEntered(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_rarrowBMouseEntered
		// rarrowB.setIcon(new
		// javax.swing.ImageIcon(System.getProperty("user.dir")+"/src/images/rarrowbig.png"));
	...
	private void larrowBMousePressed(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_larrowBMousePressed
		...
		clip2.start();
		lAction();
	}// GEN-LAST:event_larrowBMousePressed
	...
	private File backgroundSource = new File(System.getProperty("user.dir") + "/src/images/garage.jpg"),
			carSource = new File(System.getProperty("user.dir") + "/src/images/Tank-GTA2.png"),
	...
	private BufferedImage background,agility, car, barF, barE, speed, strength;

	public void paintComponent(Graphics g) {
		try {
			background = ImageIO.read(backgroundSource);
		} catch (IOException ex) {
			Logger.getLogger(FifthCar.class.getName()).log(Level.SEVERE, null, ex);
		}
		...
		g.drawImage(agility, 567 + 126, 370, null);
		g.drawImage(car, 426, 170, 150, 300, null);
		g.drawImage(speed, 575 + 126, 170, null);
		g.drawImage(strength, 525 + 126, 270, null);
		g.drawImage(barF, 497 + 126, 218, null);
		g.drawImage(barF, 561 + 126, 218, null);
		g.drawImage(barE, 625 + 126, 218, null);
		g.drawImage(barE, 689 + 126, 218, null);
		g.drawImage(barE, 753 + 126, 218, null);
		// Now strength
		g.drawImage(barF, 497 + 126, 318, null);
		g.drawImage(barF, 561 + 126, 318, null);
		g.drawImage(barF, 625 + 126, 318, null);
		g.drawImage(barF, 689 + 126, 318, null);
		g.drawImage(barF, 753 + 126, 318, null);

		g.drawImage(barF, 497 + 126, 418, null);
		g.drawImage(barE, 561 + 126, 418, null);
		g.drawImage(barE, 625 + 126, 418, null);
		g.drawImage(barE, 689 + 126, 418, null);
		g.drawImage(barE, 753 + 126, 418, null);
	...
	private javax.swing.JButton descriptionB;
