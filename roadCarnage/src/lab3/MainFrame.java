...
public class MainFrame extends javax.swing.JFrame {
    ...
    public static double MISSION = 2;
    ...
    class Levels2 extends Levels {
        ...
        public void desertAction() {
            ...
            sas.clip.stop();
            PlayerStats.currentLevel = gameObjects.stuff.Levels.DESERT;
            PlayerStats.carChosen = carChosen;
            ...
            setHighscore(PlayerStats.HIGHSCORE);
            if(PlayerStats.LAST_TRIP_SCORE >= MISSION){
                levels.unlockLevel(2);
            }
            setBalance(PlayerStats.MONEY_EARNED);
            sas.setVisible(true);
            sas.clip.start();
        }
        ...
        public void jungleAction() {
            sas.setVisible(false);
            sas.clip.stop();
            PlayerStats.currentLevel = gameObjects.stuff.Levels.JUNGLE;
            PlayerStats.carChosen = carChosen;
            Gameplay.Game game = new Gameplay.Game("GAME THREAD");
            try {
                game.join();
        ...
        public void cityAction() {
            ...
            setHighscore(PlayerStats.HIGHSCORE);
            if(PlayerStats.LAST_TRIP_SCORE >= 2*MISSION){
                unlockAll();
            }
            setBalance(PlayerStats.MONEY_EARNED);
            sas.setVisible(true);
        ...
        public void worldwideAction() {
            sas.setVisible(false);
            sas.clip.stop();
            PlayerStats.currentLevel = gameObjects.stuff.Levels.WORLD;
            PlayerStats.carChosen = carChosen;
            Gameplay.Game game = new Gameplay.Game("GAME THREAD");
            try {
                game.join();
